...
/*
  ...
  //  {
      ...
      ApplicationContainer temp = onoff1.Install (nodes.Get (2));
      temp.Start (Seconds (1.0));
      temp.Stop (Seconds (TotalTime));
		Ptr<UniformRandomVariable> var1 = CreateObject<UniformRandomVariable> ();
      ApplicationContainer temp1 = onoff1.Install (nodes.Get (1));
      temp1.Start (Seconds (10.0));
      temp1.Stop (Seconds (20.0));
    //}
