...
//Not commented in l1c2
  ...
  pos.Set ("X", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=2500.0]"));
  pos.Set ("Y", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=2500.0]"));
...
if(s!=d)
{
  ...
  AnimationInterface anim("l2.xml");
