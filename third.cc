...
int main (int argc, char *argv[])
{
  ...
  AnimationInterface anim("third.xml");
	...
	anim.SetConstantPosition(wifiStaNodes.Get(1),30.0,20.0);
	anim.SetConstantPosition(wifiStaNodes.Get(2),30.0,30.0);

	anim.SetConstantPosition(wifiApNode.Get(0),20.0,50.0);
